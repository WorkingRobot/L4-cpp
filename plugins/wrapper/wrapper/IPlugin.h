...
namespace L4::Plugin::Wrapper
{
    ...
    {
    public:
        IPlugin(libL4::Handle ClientHandle, const libL4::ClientInterface* ClientInterface, std::unique_ptr<IAuth> AuthInterface, std::unique_ptr<IUpdate> UpdateInterface);

        virtual ~IPlugin() = default;

        libL4::PluginInterface GetRawInterface();

        virtual libL4::Marshal::PluginIdentity GetIdentity() const = 0;
